...
INSERT INTO Profissional(siape, registro_conselho, cargo, vinculo, nome, status, turno) VALUES (2158958, 509529, 1, 1, 'Cristiane Dias Vacarri', TRUE, 1);
INSERT INTO Profissional(siape, registro_conselho, cargo, vinculo, nome, status, turno) VALUES (2347536, 100593, 1, 2, 'Dominique Souza Farias', TRUE, 2);
INSERT INTO Profissional(siape, registro_conselho, cargo, vinculo, nome, status, turno) VALUES (2213461, 364501, 1, 1, 'Jailma Ferreira de Oliveira', TRUE, 2);
INSERT INTO Profissional(siape, registro_conselho, cargo, vinculo, nome, status, turno) VALUES (2166265, 540713, 1, 2, 'José Augusto Dias', TRUE, 3);
INSERT INTO Profissional(siape, registro_conselho, cargo, vinculo, nome, status, turno) VALUES (1421656, 457019, 2, 3, 'Edson Costa Matos', TRUE, 1);
INSERT INTO Profissional(siape, registro_conselho, cargo, vinculo, nome, status, turno) VALUES (1359435, 81088, 1, 3, 'Simone de França Solano', TRUE, 2);
INSERT INTO Profissional(siape, registro_conselho, cargo, vinculo, nome, status, turno) VALUES (2348025, 132757, 3, 1, 'Simone de França Solano', TRUE, 2);
INSERT INTO Profissional(siape, registro_conselho, cargo, vinculo, nome, status, turno) VALUES (2327677, 126203, 5, 3, 'Andrea Gois Ribeiro', TRUE, 3);
INSERT INTO Profissional(siape, registro_conselho, cargo, vinculo, nome, status, turno) VALUES (2347740, 129366, 1, 1, 'Adriana Costa Moura', TRUE, 1);
INSERT INTO Profissional(siape, registro_conselho, cargo, vinculo, nome, status, turno) VALUES (2237664, 514545, 1, 2, 'Barbara de Jesus Oliveira Sampaio', TRUE, 2);
INSERT INTO Profissional(siape, registro_conselho, cargo, vinculo, nome, status, turno) VALUES (2347792, 72049, 1, 1, 'Edvânia Maria Santos', TRUE, 2);
INSERT INTO Profissional(siape, registro_conselho, cargo, vinculo, nome, status, turno) VALUES (2232709, 50875, 1, 2, 'Eloiza Pereira Santos', TRUE, 3);
INSERT INTO Profissional(siape, registro_conselho, cargo, vinculo, nome, status, turno) VALUES (1421550, 54731, 1, 3, 'Élida Maria de Souza', TRUE, 1);
INSERT INTO Profissional(siape, registro_conselho, cargo, vinculo, nome, status, turno) VALUES (1421651, 446531, 2, 3, 'Silvia Cristina da Silva', TRUE, 2);
INSERT INTO Profissional(siape, registro_conselho, cargo, vinculo, nome, status, turno) VALUES (2250154, 109914, 3, 1, 'Mara Maely Oliveira Roque', TRUE, 2);
INSERT INTO Profissional(siape, registro_conselho, cargo, vinculo, nome, status, turno) VALUES (1573276, 129049, 5, 2, 'Leila Cristrina Oliveira Santos', TRUE, 3);
INSERT INTO Profissional(siape, registro_conselho, cargo, vinculo, nome, status, turno) VALUES (2232671, 390379, 1, 1, 'Alicleyde Souza da Fé', TRUE, 1);
INSERT INTO Profissional(siape, registro_conselho, cargo, vinculo, nome, status, turno) VALUES (2289394, 645419, 1, 2, 'Jeymes Neves Rodrigues Paulo', TRUE, 2);
INSERT INTO Profissional(siape, registro_conselho, cargo, vinculo, nome, status, turno) VALUES (2149044, 189338, 1, 1, 'Claudileide Mendonça da Silva', TRUE, 2);
INSERT INTO Profissional(siape, registro_conselho, cargo, vinculo, nome, status, turno) VALUES (2297671, 957011, 1, 2, 'Érica Siqueira', TRUE, 3);
INSERT INTO Profissional(siape, registro_conselho, cargo, vinculo, nome, status, turno) VALUES (2265994, 525110, 1, 3, 'Zilmara Mazzê Rocha', TRUE, 1);
INSERT INTO Profissional(siape, registro_conselho, cargo, vinculo, nome, status, turno) VALUES (2149106, 202742, 2, 3, 'Lúcia Helena Ferreira Santos', TRUE, 2);
INSERT INTO Profissional(siape, registro_conselho, cargo, vinculo, nome, status, turno) VALUES (1213833, 254371, 3, 1, 'Viviane Couvo Teixeira Fontes', TRUE, 2);
INSERT INTO Profissional(siape, registro_conselho, cargo, vinculo, nome, status, turno) VALUES (2149068, 280072, 5, 2, 'Grayce Kelly Nunes Fernandes', TRUE, 3);